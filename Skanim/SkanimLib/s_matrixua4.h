	...
	public:
		...
		MatrixUA4 operator*(const MatrixUA4 &rhs) const
		{
			return MatrixUA4(
				...
				m_a[3][0] * rhs.m_a[0][0] + m_a[3][1] * rhs.m_a[1][0] + m_a[3][2] * rhs.m_a[2][0] + m_a[3][0],
				m_a[3][0] * rhs.m_a[0][1] + m_a[3][1] * rhs.m_a[1][1] + m_a[3][2] * rhs.m_a[2][1] + m_a[3][1],
				m_a[3][0] * rhs.m_a[0][2] + m_a[3][1] * rhs.m_a[1][2] + m_a[3][2] * rhs.m_a[2][2] + m_a[3][2],
				1.0f
				);
		}
